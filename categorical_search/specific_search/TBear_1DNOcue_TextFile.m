...
%    )_(   |/ \___/ (_______/|/     \||/   \__/         
%                                                       
%   __    ______   _        _______  _______           _______ 
%  /  \  (  __  \ ( (    /|(  ___  )(  ____ \|\     /|(  ____ \
%  \/) ) | (  \  )|  \  ( || (   ) || (    \/| )   ( || (    \/
%    | | | |   ) ||   \ | || |   | || |      | |   | || (__    
%    | | | |   | || (\ \) || |   | || |      | |   | ||  __)   
...
%  \____/(______/ |/    )_)(_______)(_______/(_______)(_______/
%                                                                                                   
...
function TBear_1DNOcue_TextFile( target_eccentricity, shift_angle, num_conditions, cue_size, fix_size, target_index_id )
...
num_collumns = 9; % 4 header + 2*fixations + 1target + 1distractors + buzz 
...
for j = 1:num_conditions
    ...
    Condition_cell_array( ( j + 1 ),: ) = { j ,1, 1, timing_file, fixation, fixation2 ...
        target_string, distractor1_string, sound_string };
end
