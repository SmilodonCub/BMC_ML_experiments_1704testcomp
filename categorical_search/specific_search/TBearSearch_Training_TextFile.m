...
function TBearSearch_Training_TextFile( target_eccentricity, shift_angle, num_conditions, cue_size, fix_size, target_index_id )
...
timing_file = 'TBearSearch_Training';
...
num_collumns = 12; % 4 header + 2*fixations + 1target + 3distractors + 1target'primer' + buzz 
