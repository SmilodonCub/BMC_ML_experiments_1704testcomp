...
TBear_split = regexp(target_name, '\_', 'split');
...
for j = 1:num_conditions
    ...
    elseif ismember( j, nobears_index )
        ...
        target_infostr = regexprep(target_string(7:(end-7)),'[,%!]','_');
    ...
    while d <= num_distract %do the same as above for as many additional 
        ...
        distractor_infostr = regexprep(distractor_string(7:(end-7)),'[,%!]','_');
    ...
    %Info_string = 'this is a placeholder';
