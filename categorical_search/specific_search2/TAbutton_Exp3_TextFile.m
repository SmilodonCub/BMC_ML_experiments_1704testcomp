...
%
%
% ________________ ___.           __    __                                         ________  
% \__    ___/  _  \\_ |__  __ ___/  |__/  |_  ____   ____       ____ ___  _________\_____  \ 
%   |    | /  /_\  \| __ \|  |  \   __\   __\/  _ \ /    \    _/ __ \\  \/  /\____ \ _(__  < 
%   |    |/    |    \ \_\ \  |  /|  |  |  | (  <_> )   |  \   \  ___/ >    < |  |_> >       \
%   |____|\____|__  /___  /____/ |__|  |__|  \____/|___|  /____\___  >__/\_ \|   __/______  /
%                 \/    \/                              \/_____/   \/      \/|__|         \/ 
%
%
...
function TAbutton_Exp3_TextFile( target_eccentricity, TAbutton_eccentricity, num_conditions, fix_size, ...
...
[task_folder timing_file] = fileparts('C:\monkeylogic\Experiments\categorical_search\specific_search2\TAbutton_search');
num_positions = 4;
...
TAbutton_random_array_pos = randi( stream, [1,4], [ num_conditions, 1]);
...
num_task_objects = 5 + num_distract; %2*fixations + 1target + num_distract + 2xbuzz
...
for jj = 1:num_blocks
    for j = 1:num_conditions
        ...
        TAbutton_ang_position = ang_position + pi/4;
    ...
    num2str( fix_rgb( 3 ) ) '],' num2str( fix_fill ) ',' char( TAbutton_pos_str( TAbutton_random_array_pos(j) ) ) ')' ];
        ...
        if jj == 1
            ...
            Condition_cell_array( ( j + 1 + (jj-1)*num_conditions), 1:10 ) = { j+ (jj-1)*num_conditions, ...
                info_string ,1, 2, timing_file, correct_sound_string, wrong_sound_string, fixation, TA_button, target_string };
        end
